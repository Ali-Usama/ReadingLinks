...
- [Another site for Substrate Guides](https://doc.deepernetwork.org/tutorials/v3/)
- [Ss58 Transform](https://polkadot.subscan.io/tools/ss58_transform?input=5HGjWAeFDfFCWPsjFQdVV2Msvz2XtMktvgocEZcCj68kUMaw&type=H160)
- [Substrate & EVM Accounts](https://medium.com/astar-network/using-astar-network-account-between-substrate-and-evm-656643df22a0)
- [Connecting Nodes](https://medium.com/@wilfried.kopp/your-very-own-local-polkadot-substrate-network-in-less-than-30s-300ed7913895)
...
- [Proof of Stake & its variants](https://www.tzapac.com/articles/proof-of-stake-and-its-variants-a-guide/)
- [Staking Pallet Configuration](https://hackmd.io/KQLaAnOJTMS3xmet3Gle_g)
...
- [Probabilistic Finality in substrate](https://stackoverflow.com/questions/70020224/is-it-possible-to-create-a-blockchain-with-probabilistic-finality-with-substrate)

## PoE
- [Proof of existence](https://www.shawntabrizi.com/substrate/proof-of-existence-blockchain-with-substrate/)
- [Proof of existence](https://dev.to/565ee/103-proof-of-existence-592f)

## Substrate Open-Source Repos
- [Moonbeam](https://github.com/PureStake/moonbeam)
- [Polkadot](https://github.com/paritytech/polkadot)
- [ReefChain](https://github.com/reef-defi/reef-chain)
- [Edgeware Node](https://github.com/edgeware-network/edgeware-node/)
- [ICE Network](https://github.com/web3labs/ice-substrate)
- [Clover](https://github.com/clover-network/clover)
- [RioChain](https://github.com/RioDefi/riochain)
